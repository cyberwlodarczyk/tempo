...
#define MLKEM_TEMPO_LAMBDA (8 * MLKEM_K)
#define MLKEM_TEMPO_3LAMBDA (3 * MLKEM_TEMPO_LAMBDA)
#define MLKEM_TEMPO_TAGBYTES (2 * MLKEM_TEMPO_LAMBDA)
#define MLKEM_TEMPO_APKBYTES (MLKEM_TEMPO_3LAMBDA + \
                              MLKEM_POLYVECBYTES + MLKEM_SYMBYTES)
#define MLKEM_TEMPO_SSBYTES MLKEM_TEMPO_LAMBDA
